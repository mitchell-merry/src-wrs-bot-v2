import { HexColorString, SlashCommandSubcommandBuilder } from 'discord.js';
import { DB } from '../../../db';
import { GuildEntity } from '../../../db/entities';
import UserError from '../../UserError';
import { Subcommand } from '../command';

const isHexColorString = (str: string): str is HexColorString =>
...
const SetRoleDefaultColourCommand: Subcommand = {
    data: new SlashCommandSubcommandBuilder()
        ...
        .setDescription(
            'The default colour of new roles created by the bot. Should be a hexcode, e.g. #FEE75C.',
        )
        .addStringOption(o =>
            o
                .setName('role_default_colour')
                .setDescription('The colour.')
                .setRequired(true),
        ),
    perm: 'mods',
